...
class CustomListItemsOffer extends GetView<OffersController> {
  ...
  Widget build(BuildContext context) {
    // الحصول على حالة المفضلة من الـ FavoriteController
    final FavoriteController favoriteController = Get.find<FavoriteController>();

    return InkWell(
      onTap: () {
        // يمكنك إضافة أي إجراء عند النقر على العنصر هنا
      },
      child: Card(
        child: Stack(
          children: [
                    ...
                    children: [
                      Text("${itemsModel.itemsPriceDiscount} \$",
                          style: const TextStyle(
                              ...
                              fontWeight: FontWeight.bold,
                              fontFamily: "sans")),
                      // عرض أيقونة القلب مع اللون المناسب بناءً على حالة المفضلة
                      GetBuilder<FavoriteController>(
                        builder: (controller) {
                          final isFavorite = controller.isFavorite[itemsModel.itemsId] ??
                          ...
                          return IconButton(
                            ...
                            icon: Icon(
                              ...
                              color: isFavorite ? Colors.red : AppColor.primaryColor,
                            ),
                          );
                        },
                      )
